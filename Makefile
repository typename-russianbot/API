...
# Program Settings #
SOURCE = source/main.cpp source/master.cpp source/TextBox.cpp source/Tile.cpp source/Button.cpp source/Board.cpp source/Player.cpp source/PrototypeWrapper.cpp # Source Files #
